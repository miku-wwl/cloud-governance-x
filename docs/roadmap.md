...
| M3 身份与租户基础 | Day 20-26 | 租户模型、可信上下文、tenant-aware data、OIDC 和 Entra 开发身份 | Accepted |
| M4 RBAC、端点保护与审计 | Day 27-30 | 权限/范围 RBAC、端点策略、稳定 401/403、追加式审计和安全门禁 | Accepted |
| M5 生产数据模型 | Day 31-40 | lineage、资源生命周期、成本语义、数据质量和 migration 演练 | 当前里程碑 |
