...
## 2. 前置条件
依赖 Phase 1 工程基线和 [ADR-0002](../adr/ADR-0002-migration-host-and-release-flow.md)。
...
## 6. 验证证据
Phase 1 final acceptance 验证空库 migration、幂等 rerun、同库并发拒绝、不同库隔离、失败退出码和无 DDL runtime role 行为。证据包括 [src/FinOps.Migrator](../../src/FinOps.Migrator)、[Test-DatabaseMigration.ps1](../../scripts/Test-DatabaseMigration.ps1)、[ADR-0002](../adr/ADR-0002-migration-host-and-release-flow.md) 和 [independent-acceptance-report.md](../archive/phase-1/independent-acceptance-report.md)。
...
- [docs/adr/ADR-0002-migration-host-and-release-flow.md](../adr/ADR-0002-migration-host-and-release-flow.md)
