...
namespace FinOps.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260630014542_AddAuthorizationAuditEvents")]
    partial class AddAuthorizationAuditEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinOps.Domain.Auditing.AuthorizationAuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IsHighPrivilege", "OccurredAt")
                    ...
                    b.ToTable("authorization_audit_events", (string)null);
                });
